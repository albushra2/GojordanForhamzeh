...
Route::get('tourist-register', [TouristController::class, 'register'])->name('touristregister');
Route::post('tourist-register', [TouristController::class, 'registerPost'])->name('touristregister.post');
Route::get('tourist-login', [TouristController::class, 'login'])->name('touristlogin');
Route::post('tourist-login', [TouristController::class, 'loginPost'])->name('touristlogin.post');
Route::get('tourist-profile', [TouristController::class, 'profile'])->name('touristprofile')->middleware('auth:travel_user');
Route::post('tourist-logout', [TouristController::class, 'logout'])->name('touristlogout');