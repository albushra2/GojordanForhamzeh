                        ...
                        <div class="card-block text-center text-white">
                            ...
                            <div class="btn-container">
                                <form action="{{ route('touristlogout') }}" method="POST">
                                    @csrf
                                    <button type="submit" class="button buttontn-danger">Sign Out</button>
                                </form>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-12 scrollable-list">
                                    <ul class="list-group">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                                ...
                                                <form onclick="return confirm('are you sure ?');" class="d-inline-block" action="{{ route('booking.destroy', $booking->id) }}" method="post">
                                                @csrf 
                                                @method('delete')
